 ...
 *
 * use k4\amour\tasks\AmourTask as AmourTaskTask;
 *
 * $tasks = Craft::$app->getTasks();
 * if (!$tasks->areTasksPending(AmourTaskTask::class)) {
 *     $tasks->createTask(AmourTaskTask::class);
 * }
 *
...
class AmourTask extends Task
{
    ...
    {
        return Craft::t('amour', 'AmourTask');
    }
}
