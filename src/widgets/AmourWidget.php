...
namespace k4\amour\widgets;

use k4\amour\Amour;
use k4\amour\assetbundles\amourwidgetwidget\AmourWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class AmourWidget extends Widget
{
    ...
    {
        return Craft::t('amour', 'AmourWidget');
    }
    ...
    {
        return Craft::getAlias("@k4/amour/assetbundles/amourwidgetwidget/dist/img/AmourWidget-icon.svg");
    }
    ...
    {
        Craft::$app->getView()->registerAssetBundle(AmourWidgetWidgetAsset::class);
